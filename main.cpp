...
/*
* Main program to test NumberArray class functionality
* 
* Input: None - program uses predefined test values
* Output: Demonstrates various operations on NumberArray objects including:
